admin = User.create!(name: 'Admin User', email: 'admin@yopmail.com', role: :admin, password: 'password')

user2 = User.create!(name: 'Standard User', email: 'user2@yopmail.com', role: :user, password: 'password')
user3 = User.create!(name: 'Standard User', email: 'user3@yopmail.com', role: :user, password: 'password')
user4 = User.create!(name: 'Standard User', email: 'user4@yopmail.com', role: :user, password: 'password')
user5 = User.create!(name: 'Standard User', email: 'user5@yopmail.com', role: :user, password: 'password')
user6 = User.create!(name: 'Standard User', email: 'user6@yopmail.com', role: :user, password: 'password')
